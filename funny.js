...
image1.onclick = function () {
  ...
  videoImg.style.backgroundImage = "url('images/funny1.jpg')";
  ...
  image2.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/funny2.jpg')";
    insideMainShowMore.style.display = 'none';
    function loading () {
      mainVideoAnimate.style.display = 'none';
      videoImg.style.display = 'none';
  ...
  image3.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';   
    videoImg.style.backgroundImage = "url('images/funny3.jpg')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';
  ...
  image4.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/funny4.jpg')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';
  ...
  image5.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/funny5.jpg')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';
  ...
  image6.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/funny6.jpg')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';
  ...
  image7.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/funny7.jpg')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';
  ...
  image8.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/funny8.jpg')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';

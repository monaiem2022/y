...
image1.onclick = function () {
  ...
  videoImg.style.backgroundImage = "url('images/hsoub1.png')";
  ...
  image2.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/hsoub2.png')";
    insideMainShowMore.style.display = 'none';
    function loading () {
      mainVideoAnimate.style.display = 'none';
      videoImg.style.display = 'none';
  ...
  image3.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/hsoub3.png')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';
  ...
  image4.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/hsoub4.png')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';
  ...
  image5.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/hsoub5.png')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';
  ...
  image6.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/hsoub6.png')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';
  ...
  image7.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/hsoub7.png')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';
  ...
  image8.onclick = function () {
    ...
    counterTitle1.style.display ='none';
    counterTitle2.style.display = 'none';
    videoImg.style.backgroundImage = "url('images/hsoub8.png')";
    mainVideoAnimate.style.display = 'block';
    insideMainShowMore.style.display = 'none'
    function loading () {
      mainVideoAnimate.style.display = 'none';
